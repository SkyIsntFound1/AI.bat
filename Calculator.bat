...
echo.
echo e)Square, Cube or any power (by Sky)
echo.
set /p do=Value.
if %do%== a goto add
if %do%== A goto add
...
:power1
cls
echo Square, Cube or any power (by SkyIsntFound)
echo.
...
echo.
echo To open Sky's instrutable's profile type 'I'. Type 'M' to goto main
set /p open=
